...
class AVLTree {
 ...
 private:
  ...
  bool findHelper(const string& x, AVLNode*& bn) const ;
  //helper method for pathTo
  string pathToHelper(const string& x, AVLNode *& bn) const ;
  //helper method for numNodes
  int numNodesHelper(AVLNode*& bn) const ;
  //helper method to calculate balance factor
  int balanceFactor(AVLNode *& n);
  //helper method for insert
  void insertHelper(const string& x, AVLNode *& bn);
};
