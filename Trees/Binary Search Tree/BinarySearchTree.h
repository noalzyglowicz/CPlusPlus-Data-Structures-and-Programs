...
class BinarySearchTree {
 ...
 private:
  ...
  // Any other methods you need...
   string pathToHelper(const string& x, BinaryNode *& root) const;
  //pathTo helper function
    void insertHelper(const string& x, BinaryNode*& root);
  //helper function for insert
    bool findHelper(const string& x,  BinaryNode*& root) const;
  //helper function for find
    int numNodesHelper(BinaryNode*& root) const;
  //helper function for numNodes
};
